...
/* Private defines -----------------------------------------------------------*/
#define currentMeasure_v_Pin GPIO_PIN_0
#define currentMeasure_v_GPIO_Port GPIOA
#define thermistor_1_Pin GPIO_PIN_1
#define thermistor_1_GPIO_Port GPIOA
#define thermistor_2_Pin GPIO_PIN_3
#define thermistor_2_GPIO_Port GPIOA
#define LED_LD2_Pin GPIO_PIN_5
#define LED_LD2_GPIO_Port GPIOA
#define isolator_enable_Pin GPIO_PIN_13
#define isolator_enable_GPIO_Port GPIOB
